...
public enum TemplatesEnum {
    ...
    GAME_HOME_RECONNECT, GAME_START_DOWNLOAD_NOW, GAME_START_WELCOME_BACK_TITLE,
    GAME_START_WELCOME_BACK_CONFIRM_BUTTON, GAME_START_MANDATORY_UPDATE_TITLE,
    GAME_START_MANDATORY_UPDATE_BUTTON, GAME_START_CLOSEABLE_OVERLAY_CLOSE,
    GAME_HOME_NEW_SURVIVORS, GAME_HOME_NEW_SURVIVORS_WELCOME_IN, GAME_HOME_NEW_SURVIVORS_PLUS_BUTTON, GAME_HOME_BOTTOM_BAR_SHOP_BUTTON,
    ...
    SIDEBAR_DAILY_LIFE_ESSENCE, SIDEBAR_GO_ACTION, SIDEBAR_GO_ACTION_NOTIFICATION,
    SIDEBAR_GO_ACTION_PROGRESS,
    SIDEBAR_CLAIM_ACTION, SIDEBAR_CLAIM_ACTION_REWARD, SIDEBAR_DAILY_LIGHTHOUSE_INTEL,
    SIDEBAR_DAILY_ONLINE_REWARDS,
    SIDEBAR_DAILY_WARM_WELCOME, LIGHTHOUSE_INTEL_BUBBLE,
    ...
    STOREHOUSE_CHEST, STOREHOUSE_CHEST_2, STOREHOUSE_CHEST_CURRENT, STOREHOUSE_STAMINA,
    STOREHOUSE_SELECTED_CURRENT,
    STOREHOUSE_WARM_WELCOME_CLAIM,
    ...
    INTEL_COMPLETED, INTEL_CLAIM_ALL, INTEL_VIEW, INTEL_ATTACK, INTEL_RESCUE, INTEL_EXPLORE,
    INTEL_FIRE_BEAST, INTEL_GAIN_AVAILABLE, INTEL_SCREEN_1, INTEL_SCREEN_2, INTEL_AGNES, DEPLOY_BUTTON,
